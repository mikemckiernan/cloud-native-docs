...
.. flat-table::
   ...
   * - Node Feature Discovery
     - :cspan:`1` `v0.18.3 <https://github.com/kubernetes-sigs/node-feature-discovery/releases/>`__
   ...
   * - DCGM
     - :cspan:`1` `4.5.2-1 <https://docs.nvidia.com/datacenter/dcgm/latest/release-notes/changelog.html>`__

   * - Validator for NVIDIA GPU Operator
     - v26.3.3

   * - NVIDIA KubeVirt GPU Device Plugin
     - :cspan:`1` `v1.5.0 <https://github.com/NVIDIA/kubevirt-gpu-device-plugin>`__

   * - NVIDIA vGPU Device Manager
     - :cspan:`1` `v0.4.2 <https://github.com/NVIDIA/vgpu-device-manager>`__

   * - NVIDIA GDS Driver |gds|_
     - :cspan:`1` `2.27.3 <https://github.com/NVIDIA/gds-nvidia-fs/releases>`__
